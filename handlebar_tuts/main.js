$(function() {
	...
	// The function will insert all the values from the objects in their respective places in the HTML as a string. Then we use jQuery to append the resulting HTML string into the page
});